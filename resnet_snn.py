...
parser.add_argument("--data_path", type=str, default="propdata/CIFAR10")  # choose: propdata/CIFAR10 or propdata/CIFAR100 or tiny-imagenet-200
...
parser.add_argument("--resnet_depth", type=int, choices=[18, 34], default=34)
# Z Bias
